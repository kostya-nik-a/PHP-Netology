...
<?php
  $animals = [
    'Russia' => ['Fox','Deer','Bear','Tiger','Horse','Squirrel','Wolf';
    'America' => ['Crocodile','Donkey','Bear','Squirrel','meadow dog'];
    'Mexica' => ['LEMUR','LEOPARD','wild cat','meadow dog','ground squirrels','kangaroo rat','Mexican wolf','Puma'];
    'Africa' => ['Kangaroo','Lion','Monkey','Elephant','Giraffe', 'Mammuthus columbi','LYNX'];
  ]

echo '<pre>';
print_r($animals); //выводим массив зверей
